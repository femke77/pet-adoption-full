...
const InquiryForm = () => {
    const { register, handleSubmit, formState: { errors }, clearErrors, reset } = useForm<FormInput>();
        ...
        <div className='flex flex-1 flex-wrap'>
            ...
            <div className="basis-full md:basis-1/3 ">
                {width >= 768 ? <img src={DogCat} alt="Dog and Cat" className="w-full h-auto p-6 object-cover mt-12  " />
                    : <img src={DogEyes} alt="Dog and Cat" className="w-full h-auto p-6 object-cover  " />}
            </div>

            <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col  basis-full md:basis-2/3 ">
                <Fieldset className="space-y-2 rounded-xl bg-white/5 p-6 sm:p-10">
                    ...
                    <Field>
                        <Label className="text-sm/6 font-medium text-black">Pets You Like, Questions, or Comments</Label>
                        <Textarea
                            {...register("pets")}
                ...
                <div className='flex items-center justify-between px-6 mb-2'>
                    ...
                    <input type="submit" className='flex w-20 my-2 rounded-md bg-indigo-600 px-3 py-1.5 text-sm/6 font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600' />
                </div>
                <div className='px-6 pb-4'>
                    {sent &&

                        <p className="text-green-600 font-bold">Your inquiry has been sent.</p>
