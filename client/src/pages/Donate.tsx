...
const Donate = () => {
  ...
  return (
    <div className='donate-container flex flex-col items-center  px-4 '>
      ...
      <p className='max-w-sm text-xl mt-6 mb-12 text-center'>
        Pawsome Pets Adoption is a volunteer-powered 501(c)(3) non-profit. We
        carefully guard every resource we have to maximize the number of animals
        we can save. Adoption fees do not cover all of the costs associated with
        our rescues, and we never want to turn away a dog or cat based on cost
        alone. Instead, we rely on generous donors to fund our lifesaving
        efforts and ensure that we can keep rescuing animals in need. Join our
        mission today and be a part of this incredible journey of compassion and
        hope.
      </p>

      <form
        className='mb-32 flex flex-col items-center justify-center'
      ...
      >
        ...
        {errors.amount && (
          <span className='text-red-500 font-bold mt-8'>
